...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.createModal = function ({
  ...
  for (let i = 0; i < this.length; i++) {
    ...
    Object(_core__WEBPACK_IMPORTED_MODULE_0__["default"])(this[i].getAttribute('modal-target')).fadeIn(500);
  }
};
...
/* harmony import */ var _modules_atrributes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/atrributes */ "./src/js/lib/modules/atrributes.js");
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.closest = function (selector) {
  ...
  for (let i = 0; i < this.length; i++) {
    this[i] = this[i].closest(selector) || 'Not found';
    counter++;
  }
...
/***/ "./src/js/lib/modules/atrributes.js":
/*!******************************************!*\
  !*** ./src/js/lib/modules/atrributes.js ***!
  \******************************************/
/*! no exports provided */
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.setAttr = function (attrName, attrVal) {
  for (let i = 0; i < this.length; i++) {
    if (!attrName || !attrVal) {
      return this;
    }
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#first').on('click', () => {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('div').eq(1).fadeToggle(1000);
});
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('[data-count="second"]').on('click', () => {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('div').eq(2).fadeToggle(1000);
});
...
Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').click(() => {
  Object(_lib_lib__WEBPACK_IMPORTED_MODULE_0__["default"])('#trigger').createModal({
    ...
    btns: {
      ...
      }], ["Another buttun", ['btn-warning', 'ml-10'], false, () => {
        alert('Hello, World!');
      }]]
    }
  });
